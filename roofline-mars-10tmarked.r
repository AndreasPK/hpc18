png("roofline-mars-10tmarked.png", width = 1280, height = 640)
...
plot(ai, ai * pb, xlab = "Arithmetic Intensity [FLOPS/B]",
     ...
     axes=FALSE, log = "xy", type = "l", col = "red", lwd = 2)
...
text(2, 80, "bandwidth bound", srt = 15, cex = 1.5)
